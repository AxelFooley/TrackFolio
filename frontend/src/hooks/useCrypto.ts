 ...
 *
 * @returns A React Query mutation object that accepts `{ portfolioId, walletAddress }` to start synchronization and manages optimistic updates, rollback on error, and cache invalidation on success.
 */
